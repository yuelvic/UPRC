...
public class Presentation {
    ...
    public static final class Control {
        ...
        public static final class Media {
            ...
            public static final int VOLUME_UP       = 0x13;
            public static final int VOLUME_DOWN     = 0x14;
            public static final int MUTE            = 0x15;
            public static final int FORWARD         = 0x16;
            public static final int BACKWARD        = 0x17;
    ...
    public static final class Mouse {
        ...
        public static final int LEFT_CLICK_DOWN             = 0x18;
        public static final int LEFT_CLICK_UP               = 0x19;
        public static final int RIGHT_CLICK_DOWN            = 0x1A;
        public static final int RIGHT_CLICK_UP              = 0x1B;
        public static final int MOUSE_MOVE                  = 0x1C;
